...
$url = get_url();
$callback_url = str_replace('get_token.php', 'callback.php', $url);
...
<div class="alert alert-primary" role="alert">
    Access Token、Refresh Token、ユーザ情報の取得ができたことを確認します。（このページはリロードするとエラーとなります）
</div>
<div class="container">
    <form method="post" action="refresh_token.php">
        ...
        <div class="form-group">
            <label for="code">Refresh Token（ユーザごとに保存）</label>
            <input name="refresh_token" type="text" class="form-control" id="code" placeholder="Code" value="<?=$token['refresh_token']?>">
        ...
        <button type="submit" class="btn btn-primary">Access Token を Refresh Token で更新</button>
    </form>
    <div class="form-group">
